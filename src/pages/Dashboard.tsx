...
import { Settings, LogOut, ListChecks, Archive, UserCheck } from 'lucide-react'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <span className="text-sm text-gray-300">EDIPI {user?.edipi} • MOS {user?.mos}</span>
              <button
        ...
        {signOffPreview && (
          <div className="mt-6 bg-github-gray bg-opacity-10 border border-github-border rounded-xl p-6">
            ...
            <div className="flex gap-3 mt-4">
              ...
              <button
                onClick={() => downloadJsonFile(signOffPreview.path.split('/').pop() || 'progress.json', signOffPreview.content)}
